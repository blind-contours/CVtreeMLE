...
sim_statistics <- sim_results %>%
  ...
  summarise(
    ...
    tmle_pooled_da_mse = tmle_pooled_da_bias^2 + tmle_pooled_sd,
    tmle_pooled_gt_mse = tmle_pooled_gt_bias^2 + tmle_pooled_sd,
    v_spec_da_mean_mse = v_spec_da_mean_bias^2 + v_spec_mean_sd,
    v_spec_gt_mean_mse = v_spec_gt_mean_bias^2 + v_spec_mean_sd,
    v_pooled_da_mse = v_pooled_da_bias^2 + v_pooled_mean_sd,
    v_pooled_gt_mse = v_pooled_gt_bias^2 + v_pooled_mean_sd,
