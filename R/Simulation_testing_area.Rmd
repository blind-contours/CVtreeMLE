...
library(tidyverse)
=======
>>>>>>> c9ee990a07db496f598de4deb43f876f6d7802ff

source(here("R/create_cv_folds.R"))
source(here("R/New_Sim_Data.R"))
source(here("R/CV_treeMLE.R"))
source(here("R/calc_empirical_truth.R"))
source(here("R/flatten_results.R"))
source(here("R/evaluate_marginal_rules.R"))
source(here("R/evaluate_mix_rules.R"))

source(here("R/find_common_mixture_rule.R"))
source(here("R/find_common_marginal_rule.R"))

source(here("R/marginal_decision_trees.R"))

source(here("R/marginal_nuisance_parameters.R"))
source(here("R/mixture_nuisance_parameters.R"))

source(here("R/calc_mixtures_ate.R"))
source(here("R/calc_marginal_ate.R"))
source(here("R/calc_additive_ate.R"))

source(here("R/base_calc_marg_add_ates.R"))
...
sim_data <- make_sim_data_rev_his_m3(
...
test_results <- CV_treeMLE(data = sim_data,
                                   covariates = c("W", "W2"),
                                   outcome = "y",
                                   mix_comps = c(paste("M", seq(3), sep = "")),
...
NIEH_mix_sim_dat <- read_xls(here("NIEHS_Data/dataset1.xls"))
## run on prime data
...
NIEH_results <- CV_treeMLE(data = data,
                                   covariates = covariates,
                                   outcome = outcome,
                                   mix_comps = mix_comps,
                                   SL.library = SL.library,
