#' @title Compute v-fold specific estimates and do a meta-analysis type pooled average ATE for each individual marginal rule.
...
#'
#' @param v_fold_marginal_results List of dataframes for v-fold specific estimates of the fold-specific rule results for marginals
